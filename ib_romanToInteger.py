...
A= 600
A = str(A)
# if A in IntegerToRoman:
#     return IntegerToRoman[A]
resultingRomanValue = ""
for index in range(len(A)):
    romanNumber = int(A[index]) * pow(10, len(A)-1-index)
    romanNumber = str(romanNumber)
    print(romanNumber)
    if romanNumber != "0":
        resultingRomanValue += IntegerToRoman[romanNumber]

print(resultingRomanValue)